...
# example provided from alex's workflow
alex_example = """13 45 2 0 2 -1 1 20191014 0545423900 44.7999992371 20191014 0545584090 46.0000000000
0
0
mix_-1x1_0x1_1x1
20191014 0545483960 46.0000000000 20191014 0545473950 46.0000000000 20191014 0545463930 46.0000000000 20191014 0545453930 46.0000000000 20191014 0545443920 46.0000000000 20191014 0545433900 46.0000000000 20191014 0545423900 46.0000000000 20191014 0545423900 45.7999992371 20191014 0545423900 45.5999984741 20191014 0545423900 45.4000015259 20191014 0545423900 45.2000007629 20191014 0545433900 45.2000007629 20191014 0545443920 45.2000007629 20191014 0545443920 45.2000007629 20191014 0545453930 45.2000007629 20191014 0545463930 45.0000000000 20191014 0545463930 44.7999992371 20191014 0545473950 44.7999992371 20191014 0545483960 44.7999992371 20191014 0545483960 44.7999992371 20191014 0545493970 44.7999992371 20191014 0545503970 44.7999992371 20191014 0545513990 44.7999992371 20191014 0545524000 44.7999992371 20191014 0545534010 44.7999992371 20191014 0545544040 44.7999992371 20191014 0545544040 44.7999992371 20191014 0545554050 44.7999992371 20191014 0545564070 44.7999992371 20191014 0545574080 44.7999992371 20191014 0545584090 45.0000000000 20191014 0545574080 45.2000007629 20191014 0545564070 45.2000007629 20191014 0545564070 45.2000007629 20191014 0545554050 45.2000007629 20191014 0545544040 45.2000007629 20191014 0545544040 45.4000015259 20191014 0545544040 45.5999984741 20191014 0545534010 45.5999984741 20191014 0545524000 45.5999984741 20191014 0545513990 45.5999984741 20191014 0545503970 45.5999984741 20191014 0545493970 45.5999984741 20191014 0545483960 45.7999992371 20191014 0545483960 46.0000000000 1
polygon_1"""
...
def test_process_evr_record_alex_example():
    echoview_record_manager = EchoviewRecordManager()
    output = echoview_record_manager.process_evr_record_full_geometry(
    ...
    assert output.depth_max == 46.0
    assert output.altitude == 28.97
    assert output.latitude == 40.64553
    assert output.longitude == -68.3322
    assert output.distance_from_coastline == 148669
    assert output.local_time == "2019-10-14T00:45:42.390000-05:00"
    assert output.month == 10
    assert output.solar_altitude == -52.17
    assert output.phase_of_day == "night"
    assert output.classification == "mix_-1x1_0x1_1x1"
    assert output.filename == "test.evr"
    assert output.region_id == 2
    assert output.ship == "Henry_B._Bigelow"
    assert output.cruise == "HB1906"
    assert output.instrument == "EK60"
    assert output.point_count == 45
    assert (
        output.geometry_hash
        == "7df37a609638bacb0a75897953b43df43cb8e019a45cc2db8d3640114e7fd3ab"
    )
    assert len(output.x) == 45
